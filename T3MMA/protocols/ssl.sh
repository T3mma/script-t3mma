...
ssl_stunel() {
    ...
    echo -e "\033[1;32m $(fun_trans "              SSL INSTALLER By T3MMA")"
    msg -bar
...
ssl_stunel_3() {
    ...
    install_python() {
        ...
        sleep 3
        screen -dmS pydic-80 python ${SCPinst}/python.py 80 "T3MMA" && echo "80 T3MMA" >>/etc/T3MMA/PySSL.log
        msg -bar
    }
    install_ssl() {
