...
clear
msg -bar
rm -rf /etc/T3MMA/demo-ssh 2>/dev/null
mkdir /etc/T3MMA/demo-ssh 2>/dev/null
SCPdir="/etc/T3MMA"
...
echo -e "\033[1;91m [1]-\033[1;97mUser name:\033[0;37m"
read -p " " name
if [[ -z $name ]]; then
...
echo -e "\033[1;91m [2]-\033[1;97mPassword for user $name:\033[0;37m"
read -p " " pass
echo -e "\033[1;91m [3]-\033[1;97mDuration Time In Minutes:\033[0;37m"
read -p " " tmp
if [ "$tmp" = "" ]; then
  tmp="30"
...
rm -rf /tmp/cmd
touch /etc/T3MMA/demo-ssh/$name
echo "pass: $pass" >>/etc/T3MMA/demo-ssh/$name
echo "data: ($tmp)Minutes" >>/etc/T3MMA/demo-ssh/$name
msg -bar2
echo -e "\033[1;93m ¡¡ TEMPORARY USER x MINUTES (T3MMA By @T3MMA) !!\033[0m"
msg -bar2
